...
;; Copyright (C) 2009, 2010 Frﾃｩdﾃｩric Perrin

;; Author: Frﾃｩdﾃｩric Perrin <frederic (dot) perrin (arobas) resel (dot) fr>
...
;; hilighting, speedbar/imenu support. The indentation is pretty naﾃｯve
