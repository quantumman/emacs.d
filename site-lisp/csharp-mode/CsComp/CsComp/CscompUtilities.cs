    ...
    static class AstUtils
    {
        ...
        internal static string CreateAstSexpression(string filename)
        {
            using (var fs = File.OpenRead(filename))
            {
                ...
                return SexpressionGenerator.Generate(parser.Parse(fs, filename)).ToString();
        ...
        class SexpressionGenerator
        {
            ...
            static internal StringBuilder Generate(AstNode node)
            {
                var sexp = new SexpressionGenerator();
                return sexp.NodeToStringBuilder(node.Children, null);
            }
            ...
            private void EmitLocation(TextLocation start, TextLocation end)
            {
                EmitLocation(start, end, true);
            }


            private void EmitLocation(TextLocation start, TextLocation end, bool indent)
            {
                if (indent)
            ...
            private StringBuilder NodeToStringBuilder(IEnumerable<AstNode> nodes)
            {
                foreach (var node in nodes)
                {
                    NodeToStringBuilder(node, null);
                }
            ...
            private void EmitImport(UsingDeclaration u1)
            {
                sb1.Append("(import \"")
                    .Append(u1.Namespace)
                    .Append('"');
                if (u1.NodeType.ToString().Contains("NullTypeReference"))
                    sb1.Append(" nil");
                else
                    sb1.Append(" \'").Append(u1.NodeType.ToString()).Append('\'');
            }


            private void NodeToStringBuilder(AstNode node, string overrideBlock)
            {
                ...
                if (t == typeof(ICSharpCode.NRefactory.CSharp.CompilationUnit))
                {
                    sb1.Append("'(CompilationUnit");
                }
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.UsingDeclaration))
                {
                    var u = node as ICSharpCode.NRefactory.CSharp.UsingDeclaration;
                    EmitSet("import", new[] { u }.ToList(), EmitImport);
                }
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.AttributeSection))
                {
                    var a = node as ICSharpCode.NRefactory.CSharp.AttributeSection;
                    var emitOne = new Action<ICSharpCode.NRefactory.CSharp.Attribute>((a1) =>
                        {
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.NamespaceDeclaration))
                {
                    var ns = node as ICSharpCode.NRefactory.CSharp.NamespaceDeclaration;
                    sb1.Append("(namespace \"");
                    sb1.Append(ns.Name)
                        .Append('\"');
                    //body = ns.Body;
                }
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.TypeDeclaration))
                {
                    var type = node as ICSharpCode.NRefactory.CSharp.TypeDeclaration;
                    sb1.Append("(type \"");
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.ConstructorDeclaration))
                {
                    var ctor = node as ICSharpCode.NRefactory.CSharp.ConstructorDeclaration;
                    sb1.Append("(ctor \"");
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.MethodDeclaration))
                {
                    var m = node as ICSharpCode.NRefactory.CSharp.MethodDeclaration;
                    sb1.Append("(method \"");
                    sb1.Append(m.Name)
                        .Append("\" \"")
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.LocalVariableDeclaration))
                {
                    var lvd = node as ICSharpCode.NRefactory.CSharp.LocalVariableDeclaration;
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.FieldDeclaration))
                {
                    var f = node as ICSharpCode.NRefactory.CSharp.FieldDeclaration;
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.PropertyDeclaration))
                {
                    var pd = node as ICSharpCode.NRefactory.CSharp.PropertyDeclaration;
                    var emitPropGetSet = new Action<PropertyGetSetRegion>((r) =>
                    {
                        depth++;
                        Type t1 = r.GetType();
                        String s = (t1 == typeof(ICSharpCode.NRefactory.CSharp.PropertyGetRegion))
                        ? "get" : "set";
                        ...
                        {
                            if (t1 == typeof(ICSharpCode.NRefactory.CSharp.PropertySetRegion))
                            {
                                sb1.Append('\n')
                                    .Append(indent)
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.TryCatchStatement))
                {
                    var tc = node as ICSharpCode.NRefactory.CSharp.TryCatchStatement;
                    sb1.Append("(trycatch\n");
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.BlockStatement))
                {
                    // var bs = node as ICSharpCode.NRefactory.CSharp.BlockStatement;
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.ExpressionStatement))
                {
                    // then or else
                    if (!String.IsNullOrEmpty(overrideBlock))
                        sb1.Append(overrideBlock);
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.ReturnStatement))
                {
                    sb1.Append("(return ");
                }
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.IfElseStatement))
                {
                    var ifelse = node as ICSharpCode.NRefactory.CSharp.IfElseStatement;
                    sb1.Append("(if ");
                    //sb1.Append(node.ToString());
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.ForeachStatement))
                {
                    var stmt = node as ICSharpCode.NRefactory.CSharp.ForeachStatement;
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.ForStatement))
                {
                    var fs = node as ICSharpCode.NRefactory.CSharp.ForStatement;
                    sb1.Append("(for \n");
                ...
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.SwitchStatement))
                {
                    var ss = node as ICSharpCode.NRefactory.CSharp.SwitchStatement;
                    sb1.Append("(switch ");
                    //sb1.Append(node.ToString());
                }
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.ThrowStatement))
                {
                    //var ts = node as ICSharpCode.NRefactory.CSharp.ThrowStatement;
                    sb1.Append("(throw ");
                }
                else if (t == typeof(ICSharpCode.NRefactory.CSharp.UsingStatement))
                {
                    var us = node as ICSharpCode.NRefactory.CSharp.UsingStatement;
                    sb1.Append("(using \n");
                ...
                if (node.Children != null &&
                    ((t == typeof(ICSharpCode.NRefactory.CSharp.BlockStatement)) ||
                     node.Children.Count > 0))
                {
                    int count = node.Children.Count;
                    int n = 0;

                    if (t != typeof(ICSharpCode.NRefactory.CSharp.BlockStatement))
                    {
                        sb1.Append('\n')
                            .Append(new String(' ', 2 * depth + 2))
                            .Append("(children");
                ...
                if (t != typeof(ICSharpCode.NRefactory.CSharp.CompilationUnit))
                {
                    ...
                    {
                        var p = node as ICSharpCode.NRefactory.CSharp.PropertyDeclaration;
